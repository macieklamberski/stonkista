...
Minimalist API to get current and historical price data for stocks, cryptocurrencies, and currencies from Yahoo Finance, CoinStats, and Frankfurter.
...
- **[CoinStats](https://coinstats.app)** — Cryptocurrency prices and full daily history for top 1000 coins by market cap, reaching back to 2013 for the oldest tokens.
